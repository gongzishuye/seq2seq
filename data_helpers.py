...
def loadDataset(filename):
    ...
    with open(dataset_path, 'rb') as handle:
        ...
        # print(word2id)
        # print(id2word[0],id2word[1],id2word[2],id2word[3],id2word[4],id2word[5],id2word[9],id2word[22])
        # print(trainingSamples[0])
        '''
        trainingSamples是一个list，每个元素一个list，包含encode input 和 decode input
        其中一个元素[[40, 22], [50, 9, 51, 9]]
        '''
        for sample in trainingSamples:
            sample[1].append(eosToken)
